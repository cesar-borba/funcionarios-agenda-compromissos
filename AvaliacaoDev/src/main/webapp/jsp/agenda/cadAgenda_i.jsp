...
<html>
	...
	<body class="bg-secondary">
		...
		<div class="container">
			<s:if test="#request['struts.actionMapping'].name == 'novoAgendas'">
				<s:url action="novoAgendas" var="metodoAction" includeContext="false"/>
			</s:if>
			<s:elseif test="#request['struts.actionMapping'].name == 'editarAgendas'">
				<s:url action="atualizarAgendas" var="metodoAction" includeContext="false"/>
			</s:elseif>
			<s:form action="%{metodoAction}">
				...
				<div class="card mt-5">
					...
					<div class="card-body">
						...
						<div class="row align-items-center mt-3">
							<label for="nome" class="col-sm-1 col-form-label text-center">
								<s:text name="label.formulario.periodo"/>
							</label>
							<div class="col-sm-2">
								<s:select  
									id="periodo"
